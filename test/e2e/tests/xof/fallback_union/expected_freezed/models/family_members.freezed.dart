...
FamilyMembers _$FamilyMembersFromJson(
  Map<String, dynamic> json
        ...
        switch (json['type']) {
          ...
          default:
            return FamilyMembersUnknown.fromJson(
  json
);
        }
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( FamilyMembersCat value)?  cat,TResult Function( FamilyMembersDog value)?  dog,TResult Function( FamilyMembersHuman value)?  human,TResult Function( FamilyMembersUnknown value)?  unknown,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return human(_that);case FamilyMembersUnknown() when unknown != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( FamilyMembersCat value)  cat,required TResult Function( FamilyMembersDog value)  dog,required TResult Function( FamilyMembersHuman value)  human,required TResult Function( FamilyMembersUnknown value)  unknown,}){
final _that = this;
switch (_that) {
case FamilyMembersCat():
return cat(_that);case FamilyMembersDog():
return dog(_that);case FamilyMembersHuman():
return human(_that);case FamilyMembersUnknown():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( FamilyMembersCat value)?  cat,TResult? Function( FamilyMembersDog value)?  dog,TResult? Function( FamilyMembersHuman value)?  human,TResult? Function( FamilyMembersUnknown value)?  unknown,}){
final _that = this;
switch (_that) {
case FamilyMembersCat() when cat != null:
return cat(_that);case FamilyMembersDog() when dog != null:
...
return human(_that.job);case FamilyMembersUnknown() when unknown != null:
...
return human(_that.job);case FamilyMembersUnknown():
return unknown();}
}
...
class FamilyMembersUnknown implements FamilyMembers {
  const FamilyMembersUnknown({final  String? $type}): $type = $type ?? 'unknown';
  factory FamilyMembersUnknown.fromJson(Map<String, dynamic> json) => _$FamilyMembersUnknownFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$FamilyMembersUnknownToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FamilyMembersUnknown);
}
