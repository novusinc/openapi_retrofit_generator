...
FamilyMembersUnknown _$FamilyMembersUnknownFromJson(
  Map<String, dynamic> json,
) => FamilyMembersUnknown($type: json['type'] as String?);

Map<String, dynamic> _$FamilyMembersUnknownToJson(
  FamilyMembersUnknown instance,
