...
PaymentResponseDetailsUnknown _$PaymentResponseDetailsUnknownFromJson(
  Map<String, dynamic> json,
) => PaymentResponseDetailsUnknown($type: json['paymentType'] as String?);

Map<String, dynamic> _$PaymentResponseDetailsUnknownToJson(
  PaymentResponseDetailsUnknown instance,
