...
class PaymentResponseDetailsCreditCard implements PaymentResponseDetails {
  const PaymentResponseDetailsCreditCard({required this.cardNumber, required this.expiryMonth, required this.expiryYear, required this.cvv, required this.amount, @JsonKey(includeIfNull: false) this.cardholderName, final  String? $type}): $type = $type ?? 'credit_card';
...
class PaymentResponseDetailsBankTransfer implements PaymentResponseDetails {
  const PaymentResponseDetailsBankTransfer({required this.accountNumber, required this.routingNumber, required this.amount, @JsonKey(includeIfNull: false) this.accountHolder, @JsonKey(includeIfNull: false) this.reference, final  String? $type}): $type = $type ?? 'bank_transfer';
...
class PaymentResponseDetailsCrypto implements PaymentResponseDetails {
  const PaymentResponseDetailsCrypto({required this.walletAddress, required this.cryptocurrency, required this.amount, @JsonKey(includeIfNull: false) this.transactionHash, final  String? $type}): $type = $type ?? 'crypto';
