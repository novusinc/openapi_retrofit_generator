...
mixin _$PaymentResponse {
 ...
 String get transactionId; PaymentResponseStatusStatus get status; double get amount;@JsonKey(includeIfNull: false) DateTime? get processedAt;@JsonKey(includeIfNull: false) PaymentResponseDetails? get details; String get currency;
...
@useResult
$Res call({
 String transactionId, PaymentResponseStatusStatus status, double amount,@JsonKey(includeIfNull: false) DateTime? processedAt,@JsonKey(includeIfNull: false) PaymentResponseDetails? details, String currency
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String transactionId,  PaymentResponseStatusStatus status,  double amount, @JsonKey(includeIfNull: false)  DateTime? processedAt, @JsonKey(includeIfNull: false)  PaymentResponseDetails? details,  String currency)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String transactionId,  PaymentResponseStatusStatus status,  double amount, @JsonKey(includeIfNull: false)  DateTime? processedAt, @JsonKey(includeIfNull: false)  PaymentResponseDetails? details,  String currency)  $default,) {final _that = this;
switch (_that) {
case _PaymentResponse():
return $default(_that.transactionId,_that.status,_that.amount,_that.processedAt,_that.details,_that.currency);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String transactionId,  PaymentResponseStatusStatus status,  double amount, @JsonKey(includeIfNull: false)  DateTime? processedAt, @JsonKey(includeIfNull: false)  PaymentResponseDetails? details,  String currency)?  $default,) {final _that = this;
switch (_that) {
case _PaymentResponse() when $default != null:
return $default(_that.transactionId,_that.status,_that.amount,_that.processedAt,_that.details,_that.currency);case _:
  return null;
...
@override@JsonKey(includeIfNull: false) final  PaymentResponseDetails? details;
